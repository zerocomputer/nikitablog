...
export const metadata: Metadata = {
  title: "Блог — Русский",
  description: "Записи блога на русском языке.",
  alternates: {
    languages: {
      ru: "/blog/ru",
      en: "/blog/en",
...
export default function BlogRuPage() {
  const posts = getPostsByLanguage("ru");
    ...
    <div className="max-w-4xl mx-auto px-6 py-16">
      <div className="mb-12">
        <h1 className="text-3xl font-bold tracking-tight text-white">
          ...
          <span className="ml-2 text-lg font-normal text-gray-500">🇷🇺 Русский</span>
        </h1>
